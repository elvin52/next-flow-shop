        ...
        <BrowserRouter>
          <Routes>
            <Route path="/" element={<Layout />}>
              ...
              {/* Islamic wear gender-based routing with filters and pagination */}
              <Route path=":gender" element={<IslamicProducts />} />
              <Route path=":gender/page/:page" element={<IslamicProducts />} />
              <Route path=":gender/f/:filters" element={<IslamicProducts />} />
              <Route path=":gender/f/:filters/page/:page" element={<IslamicProducts />} />
              ...
              <Route path=":gender/:category/:style/f/:filters" element={<IslamicProducts />} />
              <Route path=":gender/:category/:style/f/:filters/page/:page" element={<IslamicProducts />} />
