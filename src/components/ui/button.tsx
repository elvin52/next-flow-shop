  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:shadow-hover",
        ...
        cta: "bg-gradient-cta text-accent-foreground hover:bg-accent-hover shadow-hover hover:shadow-product font-semibold",
        hero: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-product font-bold text-base px-8 py-4",
        cart: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-card font-medium",
        checkout: "bg-success text-success-foreground hover:bg-success/90 shadow-product font-semibold text-base w-full",
      },
      size: {
